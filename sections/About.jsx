  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{once:false,amount:0.25}} className={`${styles.innerWidth} mx-auto ${styles.flexCenter} flex-col`}>
      ...
      <motion.p variants={fadeIn('up','tween','0.2','1')} className='mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white'>
        ...
        easily explore the metaverse world you want, turn your dreams into reality. Let's{' '}<span className="font-extrabold text-white">explore</span> the madness of the metaverse by scrolling down
      </motion.p>
      <motion.img variants={fadeIn('up','tween','0.3','1')} src='/arrow-down.svg' alt='arrow-down'className='w-[28px] h-[28px] object-contain mt-[28px]'/>
    </motion.div>
  </section>
);
