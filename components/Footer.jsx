    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      ...
      <div className=" flex flex-col">
        ...
        <div className=" flex items-center justify-between flex-wrap gap-4">
          ...
          <a className=" font-normal text-[14px] text-white opacity-50 hover:underline" href="https://youtu.be/tllZWCQZ9_0?si=Ak2pscChJmSaGN3F" target="_blank" rel='noopener noreferrer'>Design by JavaScript Mastery</a>
